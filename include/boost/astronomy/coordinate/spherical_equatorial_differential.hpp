...
)
{
    ...
    bg::model::point<OtherCoordinateType, 3, bg::cs::spherical_equatorial<radian>> result;
...
//!constructs object from any type of spherical differential
...
>
make_spherical_equatorial_differential(OtherDifferential const& other)
{
